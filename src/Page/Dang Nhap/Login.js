...
export default function Login() {
  ...
  return (
    ...
    >
      <div
        className="lg:flex w-1/2 object-cover hidden bg-gray-500 bg-no-repeat bg-cover relative items-center"
        style={{
          backgroundImage:
      ...
      >
        ...
        <div className="w-full py-6 z-20">
          <h1 className="text-white text-5xl font-bold">Đăng nhập</h1>
          ...
          <p className="text-gray-100">Hoặc đăng nhập bằng</p>
